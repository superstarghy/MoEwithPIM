...
def test_encoder_decoder_moe():
    ...
    model.encoder_stack.layers[0].moe_layer.router.set_mapping([[(0, 12, 1, 512, 512)]])
    model.encoder_stack.layers[0].moe_layer.experts[0].ffn1.set_mapping(
        [[(0, 6, 1, 512, 512)]]
    )
    model.encoder_stack.layers[0].moe_layer.experts[0].ffn2.set_mapping(
        [[(0, 7, 1, 512, 512)]]
    )
    model.encoder_stack.layers[0].moe_layer.experts[1].ffn1.set_mapping(
        [[(0, 8, 1, 512, 512)]]
    )
    model.encoder_stack.layers[0].moe_layer.experts[1].ffn2.set_mapping(
        [[(0, 9, 1, 512, 512)]]
    )
    model.encoder_stack.layers[0].moe_layer.experts[2].ffn1.set_mapping(
        [[(0, 10, 1, 512, 512)]]
    )
    model.encoder_stack.layers[0].moe_layer.experts[2].ffn2.set_mapping(
        [[(0, 11, 1, 512, 512)]]
    )
    ...
    model.decoder_stack.layers[0].moe_layer.router.set_mapping([[(4, 17, 1, 512, 512)]])
    model.decoder_stack.layers[0].moe_layer.experts[0].ffn1.set_mapping(
        [[(4, 11, 1, 512, 512)]]
    )
    model.decoder_stack.layers[0].moe_layer.experts[0].ffn2.set_mapping(
        [[(4, 12, 1, 512, 512)]]
    )
    model.decoder_stack.layers[0].moe_layer.experts[1].ffn1.set_mapping(
        [[(4, 13, 1, 512, 512)]]
    )
    model.decoder_stack.layers[0].moe_layer.experts[1].ffn2.set_mapping(
        [[(4, 14, 1, 512, 512)]]
    )
    model.decoder_stack.layers[0].moe_layer.experts[2].ffn1.set_mapping(
        [[(4, 15, 1, 512, 512)]]
    )
    model.decoder_stack.layers[0].moe_layer.experts[2].ffn2.set_mapping(
        [[(4, 16, 1, 512, 512)]]
    )
